        ...
        <div className="group relative rounded-3xl dark:rounded-[24px] bg-[#e0e0e0] shadow-[12px_12px_24px_rgba(163,177,198,0.55),_-12px_-12px_24px_#ffffff] dark:bg-gradient-to-b dark:from-zinc-950 dark:to-zinc-900 dark:border dark:border-zinc-800/85 dark:shadow-[0_8px_16px_rgba(0,0,0,0.9),inset_0_1px_0_rgba(255,255,255,0.08)] dark:hover:border-zinc-700 dark:hover:shadow-[0_12px_24px_rgba(0,0,0,0.9),inset_0_1px_0_rgba(255,255,255,0.2)] p-3 sm:p-4 md:p-6 transition-all duration-300">
          ...
          <div className="rounded-2xl dark:rounded-[24px] bg-[#e0e0e0] shadow-[inset_8px_8px_16px_rgba(163,177,198,0.55),_inset_-8px_-8px_16px_#ffffff] dark:bg-[#030303] dark:border dark:border-zinc-900 dark:shadow-[inset_0_4px_16px_rgba(0,0,0,0.95)] p-5 sm:p-8 md:p-12 overflow-hidden relative flex flex-col items-center justify-center min-h-[350px] md:min-h-[450px] lg:min-h-[500px] transition-all duration-300">
            ...
            <div className="relative z-10 flex flex-col items-center text-center max-w-5xl w-full gap-6 sm:gap-8">
              ...
              <div className="inline-flex items-center gap-2 sm:gap-3 px-4 sm:px-6 py-2 sm:py-3 rounded-full bg-[#e0e0e0] shadow-[inset_4px_4px_8px_rgba(163,177,198,0.55),_inset_-4px_-4px_8px_#ffffff] dark:bg-[#030303] dark:border dark:border-zinc-900 dark:shadow-[inset_0_4px_16px_rgba(0,0,0,0.95)] transition-all duration-300">
                ...
                <span className="text-[10px] sm:text-xs font-bold text-cyan-600 dark:text-cyan-400 uppercase tracking-[0.1em] sm:tracking-[0.2em] transition-colors duration-300">System Online</span>
              </div>
              
              <h1 className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold tracking-tighter text-zinc-700 dark:text-zinc-100 drop-shadow-sm transition-colors duration-300">
                Premium Hardware Neo <br className="hidden sm:block" />
                <span className="dark:text-white dark:drop-shadow-[0_0_15px_rgba(255,255,255,0.2)]">
                  & Vercel Skeuomorphism
                </span>
              </h1>
              
              <p className="text-sm sm:text-lg md:text-xl font-medium max-w-2xl text-zinc-500 dark:text-zinc-400 transition-colors duration-300 px-2 sm:px-0">
                A seamless blend of ultra-premium hardware dials in light mode, and high-contrast, deep-space neon punch in dark mode.
              </p>

              <Link href="/dashboard" className="mt-4 sm:mt-6 w-full sm:w-auto px-4 sm:px-0">
                <button className="w-full sm:w-auto px-8 sm:px-10 py-3 sm:py-4 rounded-full text-xs sm:text-sm md:text-base font-bold uppercase tracking-widest transition-all duration-200 flex items-center justify-center gap-3 bg-gradient-to-b from-white to-[#dcdfe4]/50 border-t border-white/60 shadow-[4px_4px_10px_#bebebe,_-4px_-4px_10px_#ffffff] active:shadow-[inset_2px_2px_5px_#bebebe,_inset_-2px_-2px_5px_#ffffff] dark:bg-cyan-600 dark:bg-none dark:hover:bg-cyan-500 dark:border-none dark:shadow-[0_0_20px_rgba(6,182,212,0.5)] dark:active:shadow-[inset_0_2px_8px_rgba(0,0,0,0.4)] text-cyan-700 dark:text-zinc-950">
                  <Zap className="w-4 h-4 sm:w-5 sm:h-5 shrink-0" /> <span className="truncate">Launch Mission Control</span>
                </button>
              </Link>
            </div>
          </div>
      ...
      <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 pb-12">
        {[
          ...
          <div key={idx} className="group flex flex-col p-8 rounded-3xl dark:rounded-[20px] bg-[#e0e0e0] shadow-[12px_12px_24px_rgba(163,177,198,0.55),_-12px_-12px_24px_#ffffff] dark:bg-gradient-to-b dark:from-zinc-950 dark:to-zinc-900 dark:border dark:border-zinc-800/85 dark:shadow-[0_8px_16px_rgba(0,0,0,0.9),inset_0_1px_0_rgba(255,255,255,0.08)] dark:hover:border-zinc-700 dark:hover:shadow-[0_12px_24px_rgba(0,0,0,0.9),inset_0_1px_0_rgba(255,255,255,0.2)] relative transition-all duration-300">
            ...
            <div className="w-12 h-12 sm:w-14 sm:h-14 mb-6 sm:mb-8 rounded-full bg-gradient-to-br from-[#ebebeb] to-[#c8c8c8] border border-white/60 shadow-[4px_4px_8px_#c0c0c0,_-2px_-2px_4px_#ffffff] dark:rounded-xl dark:bg-[#030303] dark:bg-none dark:border dark:border-zinc-900 dark:shadow-[inset_0_4px_16px_rgba(0,0,0,0.95)] flex items-center justify-center transition-all duration-300 relative shrink-0">
            ...
            <h3 className="text-xl sm:text-2xl font-bold text-zinc-700 dark:text-zinc-100 mb-2 sm:mb-3 tracking-tight transition-colors duration-300">{card.title}</h3>
            ...
            <div className="mt-8 sm:mt-10 flex flex-col xl:flex-row items-start xl:items-center justify-between gap-6">
              <div className="flex gap-4">
                {[1, 2, 3].map((slider) => (
                  <div key={slider} className="h-10 w-2.5 sm:h-12 sm:w-3 bg-gradient-to-b from-[#d8dcd1]/30 to-[#f5f5f5] shadow-[inset_2px_2px_4px_rgba(163,177,198,0.8),_inset_-2px_-2px_4px_#ffffff] dark:bg-[#030303] dark:bg-none dark:border dark:border-zinc-900 dark:shadow-[inset_0_2px_4px_rgba(0,0,0,0.9)] rounded-full relative overflow-hidden flex justify-center p-[2px] shrink-0">
                    <div className="w-1.5 h-3 sm:w-2 sm:h-4 rounded-full bg-cyan-500 dark:bg-cyan-400 shadow-[0_0_6px_rgba(6,182,212,0.6)] translate-y-6 group-hover:translate-y-1 transition-transform duration-500" style={{ transitionDelay: `${slider * 100}ms` }} />
                  </div>
                ))}
              </div>
